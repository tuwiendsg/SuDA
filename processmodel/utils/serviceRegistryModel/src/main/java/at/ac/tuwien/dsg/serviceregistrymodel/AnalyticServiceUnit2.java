 ...
 * @author Anindita
 */
public class AnalyticServiceUnit2 {
    public static void main(String []p)
    {
        
    
      String uri="http://DataAnalyticServiceUnit.com#";
      String objectName="AnalyticServiceUnit2";
      ...
      serviceResource.addProperty(analyticTime, "50sec/MB");
      
      Property serviceCost=model.createProperty(uri+"serviceCost");
      serviceResource.addProperty(serviceCost,"10 euro/MB");
